...
Take 2 minutes to reflect and 6 minutes to discuss.

<iframe width="320" height="100" src="https://vclock.com/embed/timer/#countdown=00:08:00&amp;enabled=0&amp;seconds=480&amp;theme=0&amp;ampm=1&amp;sound=xylophone" frameborder="0" allowfullscreen>
...
Take 3 minutes to reflect on the following scenario and consider how data science played a role in the real world example.
...
<iframe width="320" height="100" src="https://vclock.com/embed/timer/#countdown=00:03:00&amp;enabled=0&amp;seconds=180&amp;theme=0&amp;ampm=1&amp;sound=xylophone" frameborder="0" allowfullscreen>

</iframe>

## Group Discussion (7 minutes)

-   In pairs or smaller groups take 7 minutes to discuss and determine if there are any ethical issues in the real world example or potential for future dilemma. For the last 5 minutes, briefly summarize and share your groups discussion.

<iframe width="320" height="100" src="https://vclock.com/embed/timer/#countdown=00:07:00&amp;enabled=0&amp;seconds=420&amp;theme=0&amp;ampm=1&amp;sound=xylophone" frameborder="0" allowfullscreen>
...
# Ethical Practices and Considerations to Visualizations and Summary Statistics
...
### Publication
- During publication of findings, clearly convey steps, logic, and findings so that other data practitioners and the public understand.

### Protection
- Engage in research and processes that protect humans and animals throughout the research process (including data collection, analyses, and interpretation).
